...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Компьютер на базе AMD Ryzen 5 3600X
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/pc1.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>Тактовая частота	3.2 ГГц </li>
                        <li>Тип оперативной памяти	DDR4 16ГБ</li>
                        <li>Графический адаптер (видеокарта)	GeForce 1080 Ti</li>
                        <li>Твердотельный накопитель (SSD)	480 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 2999  BYN</div>
        </div>
    </section>
    <footer class="footer">
