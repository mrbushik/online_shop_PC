...
<header class="header">
    ...
    <?php endif ?> </li>
       ...
       <section>
        <div class="container">
            <div class="rec-imformation product__title">HAFF Powered by Asus TUF Gaming 11
            <img class='basket' src='../img/backet.png'>
         </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/system4.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>Процессор:  AMD Ryzen 9 5950X 16 -ядерный, 3.4 ГГц - 4.9 ГГц </li>
                        <li>Видеокарта:  Дискретная NVIDIA GeForce GTX 3060 12 ГБ</li>
                        <li>Память:  ОЗУ 32 ГБ DDR4 , SSD 2048 ГБ</li>
                        <li>Операционная система:  Dos</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 11997 BYN</div>
        </div>
    </section>
    <footer class="footer">
