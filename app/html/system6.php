...
<header class="header">
    ...
    <?php endif ?> </li>
       ...
       <section>
        <div class="container">
            <div class="rec-imformation product__title">HAFF Starter/Office Skylark P1
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/system5.jpg">
                </div>
                <div class="function__list">
                    <ul>
                    <li>Основные характеристики</li>
                        <li>Процессор:  Intel Pentium G5400 2 -ядерный, 3.7 ГГц </li>
                        <li>Видеокарта:  Встроенная Intel HD Graphics 610</li>
                        <li>Память:  ОЗУ 4 ГБ DDR4 , HDD 1000 ГБ</li>
                        <li>Операционная система:  Dos</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 771 BYN</div>
        </div>
    </section>
    <footer class="footer">
