...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">JBL Tune 500BT (синий)
            ...
            <div class="product__container">
                ...
                <div class="function__list">
                    <ul>
                        ...
                        <li>Тип разъемов:  Micro USB (для зарядки)</li>
                        <li>Время автономной работы:  16 ч</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 109  BYN</div>
        </div>
        </section>
    <footer class="footer">
