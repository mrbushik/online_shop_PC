...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">IКомпьютер на базе Intel Core i5-9400
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/pc3.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>Тактовая частота	3.6 ГГц </li>
                        <li>Тип оперативной памяти	DDR4 16ГБ</li>
                        <li>Графический адаптер (видеокарта)	GeForce RTX 2060 Super</li>
                        <li>Твердотельный накопитель (SSD)	480 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 3590  BYN</div>
        </div>
    </section>
    <footer class="footer">
