...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation  product__title">Asus TUF Gaming F15
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/notebook2.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>    Экран:  15.6 " 1920x1080 p, IPS 144 Гц, 250 кд/м2</li>
                        <li>Процессор:  Intel Core-i5 10300H 4 -ядерный, 2.5 ГГц - 4.5 ГГц, Comet Lake</li>
                        <li>Видеокарта:  Дискретная NVIDIA GeForce GTX 1650 4 ГБ GDDR6 </li>
            ...
            <div class="price">Цена: 2655  BYN</div>
        </div>
    </section>
    <footer class="footer">
