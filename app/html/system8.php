...
<header class="header">
    ...
    <?php endif ?> </li>
       ...
       <section>
        <div class="container">
            <div class="rec-imformation product__title">JET Wizard 5i8400
            ...
            <div class="product__container">
                ...
                <div class="function__list">
                    <ul>
                        ...
                        <li>Процессор:  Intel Core-i5 8400 6 -ядерный, 2.8 ГГц - 4.0 ГГц </li>
                        <li>Видеокарта:  Дискретная NVIDIA GeForce GTX1050Ti </li>
                        <li>Память:  ОЗУ 16 ГБ DDR4 , HDD 500 ГБ</li>
                        <li>Операционная система:  Dos</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 2359 BYN</div>
        </div>
    </section>
    <footer class="footer">
