...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">мышь Logitech G703 
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/mouse2.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li> Тип соединения мыши:  Беспроводная/проводная</li>
                        <li>Сенсор мыши:  Оптический </li>
                        <li>Разьем для подключения мыши:  USB, USB-ресивер </li>
                        <li>Количество кнопок мыши:  6</li>
                    </ul>
                </div>
            </div>
