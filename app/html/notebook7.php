...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Honor MagicBook X14
            <img class='basket' src='../img/backet.png'> </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/notebook7.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>     Экран:  14.0 " 1920x1080 p, IPS 60 Гц, 250 кд/м2</li>
                        <li>Процессор:  Intel Core-i3 10110U 2 -ядерный, 2.1 ГГц - 4.1 ГГц, Comet Lake</li>
                        <li>Видеокарта:  Встроенная Intel UHD Graphics 620 </li>
                        <li>Память:  ОЗУ 8 ГБ DDR4 , SSD 256 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена 1697 BYN</div>
        </div>
    </section>
    <footer class="footer">
