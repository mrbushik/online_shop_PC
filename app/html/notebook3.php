...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Lenovo IdeaPad 3
15ALC6      <img class='basket' src='../img/backet.png'></div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/notebook3.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>  Экран:  15.6 " 1920x1080 p, IPS 60 Гц, 250 кд/м2</li>
                        <li>Процессор:  Intel Core-i3 1115G4 2 -ядерный, 3.0 ГГц - 4.1 ГГц, Tiger Lake</li>
                        <li>Видеокарта:  Встроенная Intel Iris Xe Graphics G4 </li>
                        <li>Память:  ОЗУ 8 ГБ DDR4 , SSD 256 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 1497  BYN</div>
        </div>
    </section>
    <footer class="footer">
