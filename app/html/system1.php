...
<header class="header">
    ...
    <?php endif ?> </li>
       ...
       <section>
        <div class="container">
            <div class="rec-imformation product__title">HAFF Home/Multimedia P2
            <img class='basket' src='../img/backet.png'>
         </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/system1.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>Процессор:  AMD Athlon 300GE 2 -ядерный, 3.4 ГГц - 3.4 ГГц </li>
                        <li>Видеокарта:  Дискретная NVIDIA GeForce GT1030 2 ГБ</li>
                        <li>Память:  ОЗУ 4 ГБ DDR4 , SSD 480 ГБ</li>
                        <li>Операционная система:  Windows 10</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 1663 BYN</div>
        </div>
    </section>
    <footer class="footer">
