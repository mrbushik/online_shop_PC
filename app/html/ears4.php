...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Sony WH-CH510 (белый)
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="rec-imformation pdoduct__img">
                    <img src="../img/produkt/ears10.jpg">
                </div>
                <div class="function__list">
                    ...
                    <li>Диапазон частот:  20 Гц - 20000 Гц</li>
                        ...
                        <li>Время автономной работы:  35 ч</li>
                    </ul>
                </div>
            </div>
