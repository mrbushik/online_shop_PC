...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Apple Watch series SE
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/watch2.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        <li>Основные характеристики</li>
                        <li>Экран:  1.57 " AMOLED </li>
                        <li>Уведомления:  Входящие вызовы, E-mail.</li>
                        <li>Защита от пыли и влаги:  IP68</li>
                        <li>Максимальное время автономной работы:  18 ч</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 1190  BYN</div>
        </div>
    </section>
    <footer class="footer">
