...
<header class="header">
    ...
    <?php endif ?> </li>
       ...
       <section>
        <div class="container">
            <div class="rec-imformation product__title">JET Multimedia 3i8100
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/system7.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        ...
                        <li>Память:  ОЗУ 8 ГБ DDR4 , HDD 1000 ГБ</li>
                        <li>Операционная система:  Dos</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 1514 BYN</div>
        </div>
    </section>
    <footer class="footer">
