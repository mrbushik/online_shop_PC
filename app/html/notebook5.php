...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Haier U1520EM 
            ...
            <div class="product__container">
                ...
                <div class="function__list">
                    <ul>
                        ...
                        <li>       Экран:  15.6 " 1920x1080 p, IPS 60 Гц</li>
                        <li>Процессор:  Intel Celeron N4020 2 -ядерный, 1.1 ГГц - 2.8 ГГц, Gemini Lake R</li>
                        <li>Видеокарта:  Встроенная Intel </li>
                        <li>Память:  ОЗУ 4 ГБ LPDDR4 , SSD 128 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена 808 BYN</div>
        </div>
    </section>
    <footer class="footer">
