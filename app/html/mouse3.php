...
<header class="header">
    ...
    <section>
        <div class="container">
            <div class="rec-imformation product__title">Razer DeathAdder Essential
            <img class='basket' src='../img/backet.png'>
            </div>
            <div class="product__container">
                <div class="pdoduct__img">
                    <img src="../img/produkt/mouse3.jpg">
                </div>
                <div class="function__list">
                    <ul>
                        ...
                        <li>Количество кнопок мыши:  5</li>
                        <li>Разьем для подключения мыши:  USB</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена: 80  BYN</div>
        </div>
    </section>
    <footer class="footer">
