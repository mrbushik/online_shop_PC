            ...
            <div class="product__container">
                ...
                <div class="function__list">
                    <ul>
                        ...
                        <li>      Экран:  14.0 " 1366x768 p, TN+Film 60 Гц, 200 кд/м2</li>
                        <li>Процессор:  Intel Celeron N4020 2 -ядерный, 1.1 ГГц - 2.8 ГГц, Gemini Lake R</li>
                        <li>Видеокарта:  Встроенная Intel UHD Graphics 600 </li>
                        <li>Память:  ОЗУ 4 ГБ LPDDR4 , SSD 256 ГБ</li>
                    </ul>
                </div>
            </div>
            <div class="price">Цена 955 BYN</div>
        </div>
    </section>
    <footer class="footer">
